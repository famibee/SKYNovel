...
class p {
  ...
  #S(t) {
    ...
    const n = s.style;
    if (g(t, "float", !1) ? n.zIndex = `${++this.#n}` : "index" in t ? n.zIndex = `${k(t, "index", 0)}` : t.dive && (n.zIndex = `-${++this.#n}`), "alpha" in t) {
