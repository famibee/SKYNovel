...
export declare class SysApp extends SysBase {
    ...
    readonly ensureFile: (path: string) => Promise<void>;
    protected readFile(_path: string, _encoding: Parameters<typeof readFile>[1]): Promise<string>;
    protected readonly writeFile: (path: string, data: string | NodeJS.ArrayBufferView, o?: object) => Promise<void>;
    readonly appendFile: (path: string, data: string) => Promise<void>;
    readonly outputFile: (path: string, data: string) => Promise<void>;
    readonly isApp = true;
    ...
    cvsResize(): void;
    readonly copyBMFolder: (from: number, to: number) => void;
    readonly eraseBMFolder: (place: number) => void;
