                        ...
                        case 'gotxt':
                            ...
                            if (CmnLib_1.CmnLib.hDip['tx']) {
                                if (this.needGoTxt) {
                                    ...
                                    for (let i = 0; i < len; ++i)
                                        this.aSpan[i] = this.aSpan[i].replace(/ class='sn_ch_in_\S+'/, '');
                                }
                            }
                            else
                            ...
                            this.needGoTxt = true;
                            {
                                ...
                                if (CmnLib_1.CmnLib.hDip['tx']) {
                                    if (isSkip)
                                        this.cumDelay = 0;
                                    if (this.aSpan_bk)
                                        add_htm += ` class='sn_ch_in_${this.ch_in_style}' style='animation-delay: ${this.cumDelay}ms;'`;
...
`);
    ...
    set_ch_in(hArg) {
        ...
        if (ins) {
            if (!TxtStage_1.TxtStage.isChInStyle(ins))
