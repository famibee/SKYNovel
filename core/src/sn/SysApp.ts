...
top: ${(CmnLib.stageH -size) /2 +size *(td.dy ?? 0)}px;`;
	...
	: {[nm: string] :{dat: string, dx?: number, dy?: number, ease?: string}}	= {	// Thanks ICOOON MONO https://icooon-mono.com/ Base64エンコーダー https://lab.syncer.jp/Tool/Base64-encode/ (途中 https://vectr.com/ で 640x640化、ImageOptim経由)
