...
var g = class g {
	...
	static #h(e) {
		return g.#t.getVal("const.sn.needClick2Play") && (m.trace_beforeNew(`[lay系] ${m.strPos()}未クリック状態で動画を自動再生します。音声はミュートされます`, "W"), e.muted = !0), e.setAttribute("playsinline", ""), e;
	}
	...
	static add_face(e) {
		...
		return g.#u[n] = {
			...
			dx: t(e, "dx", 0),
			dy: t(e, "dy", 0),
			blendmode: p.getBlendmodeNum(e.blendmode ?? "")
		}, !1;
	}
};
//#endregion
